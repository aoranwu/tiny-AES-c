...
output_filename = "blx_roofline_"+platform+"_int.csv"
# for op_per_byte in list(range(100000, 200)) + [300, 400, 500, 1000, 5000, 10000, 50000, 100000]:
for op_per_byte in [1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000]:
    total = 0
    for i in range(repeated):
        total += float(os.popen("./get_blx_roofline "+str(op_per_byte)).read().split()[2].split(":")[1])
